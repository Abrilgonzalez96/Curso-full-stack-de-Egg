...
public class Ejercicio13 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("La ganancia por semana es " +  sc.calcularGananciaSemanal(c1));
        Curso c2 = sc.crearCurso();
        System.out.println("La ganancia por semana es " +  sc.calcularGananciaSemanal(c2));
    }
